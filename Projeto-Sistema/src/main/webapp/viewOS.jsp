        ...
        <article>
            <div class="buttonsVeiw">
                ...
                <c:if test="${uS.isFuncionario()}">
                    <a href="statusOS?id=${osView.getId()}" class="btnStatus"><button>Status</button></a>
                    <a href="#elementoOculto"><button onclick="mostraredit()" class="btnEditar">Editar</button></a>
                    <c:if test="${uS.isAdmin()}">
                        <a href="deletarOS?id=${osView.getId()}"><button class="btnDeletar">Deletar</button></a>
                    </c:if>
                </c:if>
            </div>
            <div class="detailOS">
            ...
            <form action="editarOS" class="viewForm" method="post">
                <fieldset>
                    <div>
                        <h2>Cliente: </h2>
